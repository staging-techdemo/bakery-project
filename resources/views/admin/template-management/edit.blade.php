    ...
    <div class="main-sec">
        <div class="main-wrapper">
            ...
            <div class="user-wrapper">
                <form id="add-record-form" action="{{ route('admin.update_template') }}" enctype="multipart/form-data"
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-5 text-center">
                            <div class="img-upload-wrapper ">
                                <h3>Preview Image</h3>
                                <figure>
                                    <img src="{{ asset($template->img_path) }}" class="thumbnail-img" id="profie-img"
                                        alt="thumbnail">
                                </figure>
