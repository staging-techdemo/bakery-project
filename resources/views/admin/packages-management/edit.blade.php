...
@section('content')
    ...
    <div class="main-sec">
        ...
        <div class="user-wrapper">
            <form class="main-form mc-b-3" action="{{ route('admin.update_packages') }}" method="POST"
                ...
                <div class="row ">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="sub_title" id="sub_title" value="{{ $package->sub_title }}"
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="form-group">
                            <label>Price*:</label>
                            <input type="number" name="price" id="price" value="{{ $package->price }}" min="1"
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="form-group">
                            ...
                            <select name="type">
                                ...
                                <option value="year" {{ $package->type == 'year' ? 'selected' : '' }}>Year</option>
                                <option value="month" {{ $package->type == 'month' ? 'selected' : '' }}>Month</option>
                            </select>
                            @if ($errors->has('type'))
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="form-group">
                            ...
                            <textarea rows="5" class="form-control" name="short_desc" placeholder="Enter Short Description">{{ $package->short_desc }}</textarea>
                    ...
                    @if (!$package_perks->isEmpty())
                        <div class="col-lg-12 mt-3">
                            <div class="form-group">
                                <label class="course-detail__subHeading">Current Perks:</label>
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            @foreach ($package_perks as $i => $perk)
                                                @php
                                                    $i++;
                                                @endphp
                                                <tr>
                                                    ...
                                                    <td><a class="delete-btn"
                                                            href="{{ route('admin.delete_package_perk', $perk->id) }}"><i
                        ...
                        <div class="form-group">
                            ...
                            <div class="fields-wrapper">
                                <div class="input-field--check">
                                    <input type=radio name="is_limited" value="1" id="yes_limited" {{ $package->is_limited == 1 ? 'checked' : '' }}>
                                    <label for="yes_limited" class="toggle">Yes</label>
                                </div>
                                <div class="input-field--check">
                                    <input type="radio" name="is_limited" value="0" id="no_limited" {{ $package->is_limited == 0 ? 'checked' : '' }}>
