...
<div class="main-sec">
    <div class="main-wrapper">
        ...
        <form action="{{route('admin.create_special')}}" method="POST" enctype="multipart/form-data"
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="form-group">
                        ...
                        <textarea rows="5" class="form-control ckeditor"  name="desc"  placeholder="Enter Short Description">{{old('desc')}}</textarea>
                    </div>
                </div>
