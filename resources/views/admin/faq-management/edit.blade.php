    ...
    <div class="main-sec">
        <div class="main-wrapper">
            ...
            <div class="user-wrapper">
                <form id="add-record-form" action="{{ route('admin.savefaq') }}" enctype="multipart/form-data" method="POST"
                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            <div class="form-group">
                                <label>Answer*:</label>
                                <textarea rows="5" class="form-control ckeditor" id="editor1" placeholder="Enter Answer">{{ $faq->answer }}</textarea>
