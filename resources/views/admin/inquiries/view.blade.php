          ...
          <div class="row">
            <div class="col-lg-6 col-md-12 col-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control"  value="{{$inquiry['name']}}">
              </div>
            </div>
            {{-- <div class="col-lg-6 col-md-12 col-12">
              <div class="form-group">
                <label>Company Name*:</label>
                <input type="text" class="form-control"  value="{{$inquiry['company_name']}}">
              </div>
            </div>
            --}}
            ...
            {{-- <div class="col-lg-6 col-md-6 col-12">
              <div class="form-group">
                ...
                <div class="relative-div">
                  <input type="email" class="form-control"  value="{{$inquiry['subject']}}">
                </div>
              </div>
            </div> --}}
