    ...
    <div class="main-sec">
        <div class="main-wrapper">
            ...
            <div class="user-wrapper">
                <form id="add-record-form" action="{{ route('admin.save_contest') }}" method="POST" class="main-form mc-b-3">
                    @csrf
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <input type="number" name="winning_amount" class="form-control" value="{{ old('winning_amount') }}">
