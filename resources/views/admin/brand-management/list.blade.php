                            ...
                            <tbody>
                                ...
                                @foreach ($brand as $value)
                                    <tr>
                                        <td>{{ $i }}</td>
                                        <td>{{ $value->title }}</td>
                                        <td> <img src="{{ asset($value->img_path) }}" with="100px" class="gal-img"
                                                width="100px" style="filter: brightness(0)" /> </td>
                                            ...
                                            <div class="dropdown show action-dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="action-dropdown">
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ route('admin.edit_brand', $value->id) }}"><i
                                                            class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                        Edit</a>
                                                    <a class="dropdown-item"
                                                        href="{{ route('admin.delete_brand', $value->id) }}"><i
                                                            class="fa fa-trash-o" aria-hidden="true"></i>
                                                        Delete</a>
                                                    @if ($value->is_active == 1)
                                                        <a class="dropdown-item"
                                                            href="{{ route('admin.suspend_brand', $value->id) }}"><i
