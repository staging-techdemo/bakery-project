    ...
    <div class="main-sec">
        <div class="main-wrapper">
            ...
            <div class="user-wrapper">
                <form id="add-record-form" action="{{ route('admin.createwelcomeSlider') }}" enctype="multipart/form-data"
                    ...
                    <div class="col-lg-12 text-center">
                        <div class="img-upload-wrapper  mc-b-3">
                            <h3>Slider Image</h3>
                            <figure><img src="{{ asset('images/user-details.png') }}" class="thumbnail-img" alt="user-img">
                            </figure>
                            <label for="thumbnail-img" class="user-img-btn"><i class="fa fa-camera"></i></label>
                            <input type="file" required onchange="thumb(this);" name="welcomeslider" id="thumbnail-img"
